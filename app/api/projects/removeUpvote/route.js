...
export async function POST(request) {
  ...
  try {
    ...
    const hasUpvoted = user.upvotedProjects.some(project => project.id === Number(projectId));
    ...
    return Response.json({ message: "Error removing upvote from project" }, { status: 500 });
  }
}
