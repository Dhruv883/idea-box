    ...
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <ul className="list-disc list-inside mb-4 space-y-2">
        ...
        <li>
          ...
          "Us" or "Our" in this Agreement) refers to IdeaBox.
        </li>
        <li>
        ...
        <li>
          <strong>Service Provider</strong>: A natural or legal person who
        ...
        <li>
          <strong>Website</strong>: Refers to IdeaBox, accessible from{" "}
          <a
            href="https://the-idea-box.vercel.app/"
            target="_blank"
            className="text-blue-500 underline"
          >
            https://the-idea-box.vercel.app/
          </a>
        </li>
        <li>
      ...
      <p className="mb-4">
        You have the right to delete Your Personal Data, and you can do so by
        contacting us. However, please note that we may retain certain
      ...
      <ul className="list-disc list-inside mb-4">
        <li className="mb-2">
          <strong>Business or Legal Requirements:</strong> We may disclose Your
        ...
        <li className="mb-2">
          ...
          otherwise interact with other users of the Service, such information
      ...
      <p className="mb-4">
        To exercise these rights, please contact us at the contact details
        provided below.
      </p>
      <h3 className="text-xl font-semibold mt-6 mb-2">
      ...
      <p className="mb-4">
        ...
        and terms of service of any website you visit.
      </p>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold mt-6 mb-2">Google API</h3>
      <p className="mb-4">
